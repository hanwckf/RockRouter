 ...
 */
ret_t rtl8367d_setAsicRegBit(rtk_uint32 reg, rtk_uint32 bit, rtk_uint32 value)
{
 ...
 *      None
 */
ret_t rtl8367d_getAsicRegBit(rtk_uint32 reg, rtk_uint32 bit, rtk_uint32 *pValue)
{
 ...
 */
ret_t rtl8367d_setAsicRegBits(rtk_uint32 reg, rtk_uint32 bits, rtk_uint32 value)
{
 ...
 *      None
 */
ret_t rtl8367d_getAsicRegBits(rtk_uint32 reg, rtk_uint32 bits, rtk_uint32 *pValue)
{
 ...
 */
ret_t rtl8367d_setAsicReg(rtk_uint32 reg, rtk_uint32 value)
{
 ...
 */
ret_t rtl8367d_getAsicReg(rtk_uint32 reg, rtk_uint32 *pValue)
{
