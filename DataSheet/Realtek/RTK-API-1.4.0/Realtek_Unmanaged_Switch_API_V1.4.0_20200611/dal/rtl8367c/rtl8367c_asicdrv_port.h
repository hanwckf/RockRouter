...
extern ret_t rtl8367c_setFiberAbilityExt(rtk_uint32 ext_id, rtk_uint32 pause, rtk_uint32 asypause);
extern ret_t rtl8367c_getFiberAbilityExt(rtk_uint32 ext_id, rtk_uint32* pPause, rtk_uint32* pAsypause);
