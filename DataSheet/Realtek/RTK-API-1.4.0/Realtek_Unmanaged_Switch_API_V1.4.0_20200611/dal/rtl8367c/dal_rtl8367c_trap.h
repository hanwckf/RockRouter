...
#ifndef __DAL_RTL8367C_TRAP_H__
#define __DAL_RTL8367C_TRAP_H__

#include <trap.h>

/* Function Name:
 *      dal_rtl8367c_trap_unknownUnicastPktAction_set
 * Description:
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_trap_unknownUnicastPktAction_set(rtk_port_t port, rtk_trap_ucast_action_t ucast_action);

/* Function Name:
 *      dal_rtl8367c_trap_unknownUnicastPktAction_get
 * Description:
 ...
 *          - UCAST_ACTION_FLOODING
 */
extern rtk_api_ret_t dal_rtl8367c_trap_unknownUnicastPktAction_get(rtk_port_t port, rtk_trap_ucast_action_t *pUcast_action);

/* Function Name:
 *      dal_rtl8367c_trap_unknownMacPktAction_set
 * Description:
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_trap_unknownMacPktAction_set(rtk_trap_ucast_action_t ucast_action);

/* Function Name:
 *      dal_rtl8367c_trap_unknownMacPktAction_get
 * Description:
 ...
 *
 */
extern rtk_api_ret_t dal_rtl8367c_trap_unknownMacPktAction_get(rtk_trap_ucast_action_t *pUcast_action);

/* Function Name:
 *      dal_rtl8367c_trap_unmatchMacPktAction_set
 * Description:
 ...
 *          - UCAST_ACTION_COPY28051
 */
extern rtk_api_ret_t dal_rtl8367c_trap_unmatchMacPktAction_set(rtk_trap_ucast_action_t ucast_action);

/* Function Name:
 *      dal_rtl8367c_trap_unmatchMacPktAction_get
 * Description:
 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
extern rtk_api_ret_t dal_rtl8367c_trap_unmatchMacPktAction_get(rtk_trap_ucast_action_t *pUcast_action);

/* Function Name:
 *      dal_rtl8367c_trap_unmatchMacMoving_set
 * Description:
 ...
 * Note:
 */
extern rtk_api_ret_t dal_rtl8367c_trap_unmatchMacMoving_set(rtk_port_t port, rtk_enable_t enable);

/* Function Name:
 *      dal_rtl8367c_trap_unmatchMacMoving_get
 * Description:
 *      Set unmatch source MAC packet moving state.
 * Input:
 *      port        - Port ID.
 ...
 * Note:
 */
extern rtk_api_ret_t dal_rtl8367c_trap_unmatchMacMoving_get(rtk_port_t port, rtk_enable_t *pEnable);

/* Function Name:
 *      dal_rtl8367c_trap_unknownMcastPktAction_set
 * Description:
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_trap_unknownMcastPktAction_set(rtk_port_t port, rtk_mcast_type_t type, rtk_trap_mcast_action_t mcast_action);
 ...
 *          - MCAST_ACTION_TRAP2CPU
 */
extern rtk_api_ret_t dal_rtl8367c_trap_unknownMcastPktAction_get(rtk_port_t port, rtk_mcast_type_t type, rtk_trap_mcast_action_t *pMcast_action);

/* Function Name:
 *      dal_rtl8367c_trap_lldpEnable_set
 * Description:
 *      Set LLDP enable.
 * Input:
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_trap_lldpEnable_set(rtk_enable_t enabled);

/* Function Name:
 *      dal_rtl8367c_trap_lldpEnable_get
 * Description:
 *      Get LLDP status.
 * Input:
 *      None
 ...
 *      - 01:80:c2:00:00:00 ethertype = 0x88CC
 */
extern rtk_api_ret_t dal_rtl8367c_trap_lldpEnable_get(rtk_enable_t *pEnabled);

/* Function Name:
 *      dal_rtl8367c_trap_reasonTrapToCpuPriority_set
 * Description:
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_trap_reasonTrapToCpuPriority_set(rtk_trap_reason_type_t type, rtk_pri_t priority);
 ...
 *      - TRAP_REASON_UNKNOWNMC
 */
extern rtk_api_ret_t dal_rtl8367c_trap_reasonTrapToCpuPriority_get(rtk_trap_reason_type_t type, rtk_pri_t *pPriority);

/* Function Name:
 *      dal_rtl8367c_trap_rmaAction_set
 * Description:
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_trap_rmaAction_set(rtk_trap_type_t type, rtk_trap_rma_action_t rma_action);

/* Function Name:
 *      dal_rtl8367c_trap_rmaAction_get
 * Description:
 ...
 *      - RMA_ACTION_FORWARD_EXCLUDE_CPU
 */
extern rtk_api_ret_t dal_rtl8367c_trap_rmaAction_get(rtk_trap_type_t type, rtk_trap_rma_action_t *pRma_action);

/* Function Name:
 *      dal_rtl8367c_trap_rmaKeepFormat_set
 * Description:
 ...
 *      - TRAP_LLDP.
 */
extern rtk_api_ret_t dal_rtl8367c_trap_rmaKeepFormat_set(rtk_trap_type_t type, rtk_enable_t enable);

/* Function Name:
 *      dal_rtl8367c_trap_rmaKeepFormat_get
 * Description:
 *      Get Reserved multicast address action configuration.
 * Input:
 *      type - rma type.
 ...
 *      - TRAP_LLDP.
 */
extern rtk_api_ret_t dal_rtl8367c_trap_rmaKeepFormat_get(rtk_trap_type_t type, rtk_enable_t *pEnable);
