 ...
 *      This API enables H/W IGMP and set a default initial configuration.
 */
rtk_api_ret_t dal_rtl8367c_igmp_init(void)
{
 ...
 *      This API set H/W IGMP state.
 */
rtk_api_ret_t dal_rtl8367c_igmp_state_set(rtk_enable_t enabled)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_igmp_state_get(rtk_enable_t *pEnabled)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_igmp_static_router_port_set(rtk_portmask_t *pPortmask)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pmask;
 ...
 */
rtk_api_ret_t dal_rtl8367c_igmp_static_router_port_get(rtk_portmask_t *pPortmask)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pmask;
 ...
 */
rtk_api_ret_t dal_rtl8367c_igmp_protocol_set(rtk_port_t port, rtk_igmp_protocol_t protocol, rtk_igmp_action_t action)
{
 ...
 *      This API set IGMP/MLD protocol action
 */
rtk_api_ret_t dal_rtl8367c_igmp_protocol_get(rtk_port_t port, rtk_igmp_protocol_t protocol, rtk_igmp_action_t *pAction)
{
    rtk_uint32      operation;
    rtk_api_ret_t   retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_igmp_fastLeave_set(rtk_enable_t state)
{
    rtk_api_ret_t   retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_igmp_fastLeave_get(rtk_enable_t *pState)
{
 ...
 */
rtk_api_ret_t dal_rtl8367c_igmp_maxGroup_set(rtk_port_t port, rtk_uint32 group)
{
    rtk_api_ret_t   retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_igmp_maxGroup_get(rtk_port_t port, rtk_uint32 *pGroup)
{
    rtk_api_ret_t   retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_igmp_currentGroup_get(rtk_port_t port, rtk_uint32 *pGroup)
{
    rtk_api_ret_t   retVal;
 ...
 * Note:
 */
rtk_api_ret_t dal_rtl8367c_igmp_tableFullAction_set(rtk_igmp_tableFullAction_t action)
{
    rtk_api_ret_t   retVal;
 ...
 * Note:
 */
rtk_api_ret_t dal_rtl8367c_igmp_tableFullAction_get(rtk_igmp_tableFullAction_t *pAction)
{
    rtk_api_ret_t   retVal;
 ...
 * Note:
 */
rtk_api_ret_t dal_rtl8367c_igmp_checksumErrorAction_set(rtk_igmp_checksumErrorAction_t action)
{
    rtk_api_ret_t   retVal;
 ...
 * Note:
 */
rtk_api_ret_t dal_rtl8367c_igmp_checksumErrorAction_get(rtk_igmp_checksumErrorAction_t *pAction)
{
    rtk_api_ret_t   retVal;
 ...
 * Note:
 */
rtk_api_ret_t dal_rtl8367c_igmp_leaveTimer_set(rtk_uint32 timer)
{
    rtk_api_ret_t   retVal;
 ...
 * Note:
 */
rtk_api_ret_t dal_rtl8367c_igmp_leaveTimer_get(rtk_uint32 *pTimer)
{
    rtk_api_ret_t   retVal;
 ...
 * Note:
 */
rtk_api_ret_t dal_rtl8367c_igmp_queryInterval_set(rtk_uint32 interval)
{
    rtk_api_ret_t   retVal;
 ...
 * Note:
 */
rtk_api_ret_t dal_rtl8367c_igmp_queryInterval_get(rtk_uint32 *pInterval)
{
    rtk_api_ret_t   retVal;
 ...
 * Note:
 */
rtk_api_ret_t dal_rtl8367c_igmp_robustness_set(rtk_uint32 robustness)
{
    rtk_api_ret_t   retVal;
 ...
 * Note:
 */
rtk_api_ret_t dal_rtl8367c_igmp_robustness_get(rtk_uint32 *pRobustness)
{
    rtk_api_ret_t   retVal;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_igmp_dynamicRouterPortAllow_set(rtk_portmask_t *pPortmask)
{
    rtk_api_ret_t   retVal;
    rtk_uint32 pmask;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_igmp_dynamicRouterPortAllow_get(rtk_portmask_t *pPortmask)
{
    rtk_api_ret_t   retVal;
    rtk_uint32 pmask;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_igmp_dynamicRouterPort_get(rtk_igmp_dynamicRouterPort_t *pDynamicRouterPort)
{
    rtk_api_ret_t   retVal;
    rtk_uint32 port;
    rtk_uint32 timer;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_igmp_suppressionEnable_set(rtk_enable_t reportSuppression, rtk_enable_t leaveSuppression)
{
    rtk_api_ret_t   retVal;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_igmp_suppressionEnable_get(rtk_enable_t *pReportSuppression, rtk_enable_t *pLeaveSuppression)
{
    rtk_api_ret_t   retVal;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_igmp_portRxPktEnable_set(rtk_port_t port, rtk_igmp_rxPktEnable_t *pRxCfg)
{
    rtk_api_ret_t   retVal;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_igmp_portRxPktEnable_get(rtk_port_t port, rtk_igmp_rxPktEnable_t *pRxCfg)
{
    rtk_api_ret_t   retVal;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_igmp_groupInfo_get(rtk_uint32 index, rtk_igmp_groupInfo_t *pGroup)
{
    rtk_api_ret_t   retVal;
    rtk_uint32      valid;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_igmp_ReportLeaveFwdAction_set(rtk_igmp_ReportLeaveFwdAct_t action)
{
    rtk_api_ret_t   retVal;
    rtk_uint32      regData;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_igmp_ReportLeaveFwdAction_get(rtk_igmp_ReportLeaveFwdAct_t *pAction)
{
    rtk_api_ret_t   retVal;
    rtk_uint32      regData;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_igmp_dropLeaveZeroEnable_set(rtk_enable_t enabled)
{
    rtk_api_ret_t   retVal;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_igmp_dropLeaveZeroEnable_get(rtk_enable_t *pEnabled)
{
    rtk_api_ret_t   retVal;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_igmp_bypassGroupRange_set(rtk_igmp_bypassGroup_t group, rtk_enable_t enabled)
{
    rtk_api_ret_t   retVal;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_igmp_bypassGroupRange_get(rtk_igmp_bypassGroup_t group, rtk_enable_t *pEnable)
{
    rtk_api_ret_t   retVal;
