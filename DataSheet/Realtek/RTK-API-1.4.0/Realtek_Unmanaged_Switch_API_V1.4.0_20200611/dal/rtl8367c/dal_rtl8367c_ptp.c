 ...
 */
rtk_api_ret_t dal_rtl8367c_ptp_init(void)
{
 ...
 *      None
 */
rtk_api_ret_t dal_rtl8367c_ptp_mac_set(rtk_mac_t mac)
{
 ...
 *      None
 */
 rtk_api_ret_t dal_rtl8367c_ptp_mac_get(rtk_mac_t *pMac)
{
    rtk_api_ret_t retVal;
    ether_addr_t sw_mac;
 ...
 *      None
 */
rtk_api_ret_t dal_rtl8367c_ptp_tpid_set(rtk_ptp_tpid_t outerId, rtk_ptp_tpid_t innerId)
{
    rtk_api_ret_t retVal;
 ...
 *      None
 */
rtk_api_ret_t dal_rtl8367c_ptp_tpid_get(rtk_ptp_tpid_t *pOuterId, rtk_ptp_tpid_t *pInnerId)
{
    rtk_api_ret_t retVal;
 ...
 *      None
 */
rtk_api_ret_t dal_rtl8367c_ptp_refTime_set(rtk_ptp_timeStamp_t timeStamp)
{
    rtk_api_ret_t retVal;
 ...
 *      None
 */
rtk_api_ret_t dal_rtl8367c_ptp_refTime_get(rtk_ptp_timeStamp_t *pTimeStamp)
{
    rtk_api_ret_t retVal;
 ...
 */
 rtk_api_ret_t dal_rtl8367c_ptp_refTimeAdjust_set(rtk_ptp_sys_adjust_t sign, rtk_ptp_timeStamp_t timeStamp)
{
    rtk_api_ret_t retVal;
 ...
 *      None
 */
 rtk_api_ret_t dal_rtl8367c_ptp_refTimeEnable_set(rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
 ...
 *      None
 */
 rtk_api_ret_t dal_rtl8367c_ptp_refTimeEnable_get(rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
 ...
 *      None
 */
rtk_api_ret_t dal_rtl8367c_ptp_portEnable_set(rtk_port_t port, rtk_enable_t enable)
{
    rtk_api_ret_t   retVal;
 ...
 *      None
 */
rtk_api_ret_t dal_rtl8367c_ptp_portEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
 ...
 *      None
 */
rtk_api_ret_t dal_rtl8367c_ptp_portTimestamp_get( rtk_port_t port, rtk_ptp_msgType_t type, rtk_ptp_info_t *pInfo)
{
    rtk_api_ret_t retVal;
 ...
 *          PTP_INT_TYPE_ALL,
 */
rtk_api_ret_t dal_rtl8367c_ptp_intControl_set(rtk_ptp_intType_t type, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
    rtk_uint32 mask;
 ...
 *          PTP_INT_TYPE_RX_PDELAY_RESP,
 */
 rtk_api_ret_t dal_rtl8367c_ptp_intControl_get(rtk_ptp_intType_t type, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
    rtk_uint32 mask;
 ...
 *
 */
 rtk_api_ret_t dal_rtl8367c_ptp_intStatus_get(rtk_ptp_intStatus_t *pStatusMask)
{
    rtk_api_ret_t   retVal;
 ...
 */
 rtk_api_ret_t dal_rtl8367c_ptp_portIntStatus_set(rtk_port_t port, rtk_ptp_intStatus_t statusMask)
{
    rtk_api_ret_t retVal;
 ...
 *
 */
 rtk_api_ret_t dal_rtl8367c_ptp_portIntStatus_get(rtk_port_t port, rtk_ptp_intStatus_t *pStatusMask)
{
    rtk_api_ret_t   retVal;
 ...
 *      None
 */
 rtk_api_ret_t dal_rtl8367c_ptp_portTrap_set(rtk_port_t port, rtk_enable_t enable)
{
    rtk_api_ret_t   retVal;
 ...
 *      None
 */
 rtk_api_ret_t dal_rtl8367c_ptp_portTrap_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
