...
rtk_api_ret_t dal_rtl8367c_svlan_lookupType_set(rtk_svlan_lookupType_t type);
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_init(void)
{
    rtk_uint32 i;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_servicePort_add(rtk_port_t port)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pmsk;
    rtk_uint32 phyPort;
 ...
 *      contain accept SVID in S-tag field.
 */
rtk_api_ret_t dal_rtl8367c_svlan_servicePort_get(rtk_portmask_t *pSvlan_portmask)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_servicePort_del(rtk_port_t port)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pmsk;
    rtk_uint32 phyPort;
 ...
 *      User can set mathced ether type as service provider supported protocol.
 */
rtk_api_ret_t dal_rtl8367c_svlan_tpidEntry_set(rtk_uint32 svlan_tag_id)
{
    rtk_api_ret_t retVal;
 ...
 *      contain accept SVID in S-tag field.
 */
rtk_api_ret_t dal_rtl8367c_svlan_tpidEntry_get(rtk_uint32 *pSvlan_tag_id)
{
    rtk_api_ret_t retVal;
 ...
 *      - REF_PB_PRI.
 */
rtk_api_ret_t dal_rtl8367c_svlan_priorityRef_set(rtk_svlan_pri_ref_t ref)
{
    rtk_api_ret_t retVal;
 ...
 *      - REF_PB_PRI
 */
rtk_api_ret_t dal_rtl8367c_svlan_priorityRef_get(rtk_svlan_pri_ref_t *pRef)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_memberPortEntry_set(rtk_vlan_t svid, rtk_svlan_memberCfg_t *pSvlan_cfg)
{
    rtk_api_ret_t retVal;
    rtk_int32 i;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_memberPortEntry_get(rtk_vlan_t svid, rtk_svlan_memberCfg_t *pSvlan_cfg)
{
    rtk_api_ret_t retVal;
    rtk_uint32 i;
    rtl8367c_svlan_memconf_t svlanMemConf;
 ...
 *      - rtk_svlan_memberCfg_t->priority is priority of SVLAN member configuration.
 */
rtk_api_ret_t dal_rtl8367c_svlan_memberPortEntry_adv_set(rtk_uint32 idx, rtk_svlan_memberCfg_t *pSvlan_cfg)
{
    rtk_api_ret_t retVal;
    rtl8367c_svlan_memconf_t svlanMemConf;
    rtk_uint32 phyMbrPmask;
 ...
 *      to receiving from uplink ports. Other SVID S-tag frame or S-untagged frame will be droped.
 */
rtk_api_ret_t dal_rtl8367c_svlan_memberPortEntry_adv_get(rtk_uint32 idx, rtk_svlan_memberCfg_t *pSvlan_cfg)
{
    rtk_api_ret_t retVal;
    rtl8367c_svlan_memconf_t svlanMemConf;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_defaultSvlan_set(rtk_port_t port, rtk_vlan_t svid)
{
    rtk_api_ret_t retVal;
    rtk_uint32 i;
    rtl8367c_svlan_memconf_t svlanMemConf;
 ...
 *      is transmit through uplink port with s-tag field
 */
rtk_api_ret_t dal_rtl8367c_svlan_defaultSvlan_get(rtk_port_t port, rtk_vlan_t *pSvid)
{
    rtk_api_ret_t retVal;
    rtk_uint32 idx;
    rtl8367c_svlan_memconf_t svlanMemConf;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_c2s_add(rtk_vlan_t vid, rtk_port_t src_port, rtk_vlan_t svid)
{
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_c2s_del(rtk_vlan_t vid, rtk_port_t src_port)
{
    rtk_api_ret_t retVal;
    rtk_uint32 i;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_c2s_get(rtk_vlan_t vid, rtk_port_t src_port, rtk_vlan_t *pSvid)
{
    rtk_api_ret_t retVal;
    rtk_uint32 i;
    rtk_uint32 evid, pmsk, svidx;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_untag_action_set(rtk_svlan_untag_action_t action, rtk_vlan_t svid)
{
    rtk_api_ret_t   retVal;
    rtk_uint32      i;
    rtl8367c_svlan_memconf_t svlanMemConf;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_untag_action_get(rtk_svlan_untag_action_t *pAction, rtk_vlan_t *pSvid)
{
    rtk_api_ret_t   retVal;
    rtk_uint32      svidx;
    rtl8367c_svlan_memconf_t svlanMemConf;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_unmatch_action_set(rtk_svlan_unmatch_action_t action, rtk_vlan_t svid)
{
    rtk_api_ret_t   retVal;
    rtk_uint32      i;
    rtl8367c_svlan_memconf_t svlanMemConf;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_unmatch_action_get(rtk_svlan_unmatch_action_t *pAction, rtk_vlan_t *pSvid)
{
    rtk_api_ret_t   retVal;
    rtk_uint32      svidx;
    rtl8367c_svlan_memconf_t svlanMemConf;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_unassign_action_set(rtk_svlan_unassign_action_t action)
{
    rtk_api_ret_t   retVal;
 ...
 *      None
 */
rtk_api_ret_t dal_rtl8367c_svlan_unassign_action_get(rtk_svlan_unassign_action_t *pAction)
{
    rtk_api_ret_t   retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_dmac_vidsel_set(rtk_port_t port, rtk_enable_t enable)
{
    rtk_api_ret_t   retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_dmac_vidsel_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    rtk_api_ret_t   retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_ipmc2s_add(ipaddr_t ipmc, ipaddr_t ipmcMsk, rtk_vlan_t svid)
{
    rtk_api_ret_t retVal, i;
    rtk_uint32 empty_idx;
    rtk_uint32 svidx;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_ipmc2s_del(ipaddr_t ipmc, ipaddr_t ipmcMsk)
{
    rtk_api_ret_t retVal;
    rtk_uint32 i;
    rtl8367c_svlan_mc2s_t svlanMC2SConf;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_ipmc2s_get(ipaddr_t ipmc, ipaddr_t ipmcMsk, rtk_vlan_t *pSvid)
{
    rtk_api_ret_t retVal;
    rtk_uint32 i;
    rtl8367c_svlan_memconf_t svlanMemConf;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_l2mc2s_add(rtk_mac_t mac, rtk_mac_t macMsk, rtk_vlan_t svid)
{
    rtk_api_ret_t retVal, i;
    rtk_uint32 empty_idx;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_l2mc2s_del(rtk_mac_t mac, rtk_mac_t macMsk)
{
    rtk_api_ret_t retVal;
    rtk_uint32 i;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_l2mc2s_get(rtk_mac_t mac, rtk_mac_t macMsk, rtk_vlan_t *pSvid)
{
    rtk_api_ret_t retVal;
    rtk_uint32 i;
    rtk_uint32 l2add,l2Mask;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_sp2c_add(rtk_vlan_t svid, rtk_port_t dst_port, rtk_vlan_t cvid)
{
    rtk_api_ret_t retVal, i;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_sp2c_get(rtk_vlan_t svid, rtk_port_t dst_port, rtk_vlan_t *pCvid)
{
    rtk_api_ret_t retVal;
    rtk_uint32 i, svidx;
    rtl8367c_svlan_memconf_t svlanMemConf;
 ...
 */
rtk_api_ret_t dal_rtl8367c_svlan_sp2c_del(rtk_vlan_t svid, rtk_port_t dst_port)
{
    rtk_api_ret_t retVal;
    rtk_uint32 i, svidx;
    rtl8367c_svlan_memconf_t svlanMemConf;
 ...
 *      none
 */
rtk_api_ret_t dal_rtl8367c_svlan_lookupType_get(rtk_svlan_lookupType_t *pType)
{
    rtk_api_ret_t   retVal;
 ...
 *      None
 */
rtk_api_ret_t dal_rtl8367c_svlan_trapPri_set(rtk_pri_t priority)
{
    rtk_api_ret_t   retVal;
 ...
 *      None
 */
rtk_api_ret_t dal_rtl8367c_svlan_trapPri_get(rtk_pri_t *pPriority)
{
    rtk_api_ret_t   retVal;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_svlan_checkAndCreateMbr(rtk_vlan_t vid, rtk_uint32 *pIndex)
{
    rtk_api_ret_t retVal;
    rtk_uint32 svidx;
