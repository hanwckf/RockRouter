 ...
 */
rtk_api_ret_t dal_rtl8367c_int_polarity_set(rtk_int_polarity_t type)
{
 ...
 */
rtk_api_ret_t dal_rtl8367c_int_polarity_get(rtk_int_polarity_t *pType)
{
    rtk_api_ret_t retVal;
 ...
 *      - INT_TYPE_SLIENT
 */
rtk_api_ret_t dal_rtl8367c_int_control_set(rtk_int_type_t type, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
    rtk_uint32 mask;
 ...
 *      - INT_TYPE_SLIENT
 */
rtk_api_ret_t dal_rtl8367c_int_control_get(rtk_int_type_t type, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
    rtk_uint32 mask;
 ...
 */
rtk_api_ret_t dal_rtl8367c_int_status_set(rtk_int_status_t *pStatusMask)
{
    rtk_api_ret_t retVal;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_int_status_get(rtk_int_status_t* pStatusMask)
{
    rtk_api_ret_t   retVal;
    rtk_uint32          ims_mask;
 ...
 *      The status will be cleared after execute this API.
 */
rtk_api_ret_t dal_rtl8367c_int_advanceInfo_get(rtk_int_advType_t adv_type, rtk_int_info_t *pInfo)
{
    rtk_api_ret_t   retVal;
    rtk_uint32      data;
