 ...
 */
rtk_api_ret_t dal_rtl8367c_trap_unknownUnicastPktAction_set(rtk_port_t port, rtk_trap_ucast_action_t ucast_action)
{
 ...
 *          - UCAST_ACTION_FLOODING
 */
rtk_api_ret_t dal_rtl8367c_trap_unknownUnicastPktAction_get(rtk_port_t port, rtk_trap_ucast_action_t *pUcast_action)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_trap_unknownMacPktAction_set(rtk_trap_ucast_action_t ucast_action)
{
    rtk_api_ret_t retVal;
    rtk_uint32 behavior;
    ...
    switch (ucast_action)
    {
        case UCAST_ACTION_FORWARD_PMASK:
            behavior = L2_BEHAVE_SA_FLOODING;
            break;
        case UCAST_ACTION_DROP:
            behavior = L2_BEHAVE_SA_DROP;
            break;
        case UCAST_ACTION_TRAP2CPU:
            behavior = L2_BEHAVE_SA_TRAP;
            break;
        case UCAST_ACTION_COPY28051:
            behavior = L2_BEHAVE_SA_COPY28051;
            break;
        default:
            return RT_ERR_INPUT;
            break;
    ...
    if ((retVal = rtl8367c_setAsicPortUnknownSaBehavior(behavior)) != RT_ERR_OK)
        return retVal;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_trap_unknownMacPktAction_get(rtk_trap_ucast_action_t *pUcast_action)
{
    rtk_api_ret_t retVal;
    rtk_uint32 behavior;
    ...
    if ((retVal = rtl8367c_getAsicPortUnknownSaBehavior(&behavior)) != RT_ERR_OK)
        return retVal;

    switch (behavior)
    {
        case L2_BEHAVE_SA_FLOODING:
            *pUcast_action = UCAST_ACTION_FORWARD_PMASK;
            break;
        case L2_BEHAVE_SA_DROP:
            *pUcast_action = UCAST_ACTION_DROP;
            break;
        case L2_BEHAVE_SA_TRAP:
            *pUcast_action = UCAST_ACTION_TRAP2CPU;
            break;
        case L2_BEHAVE_SA_COPY28051:
            *pUcast_action = UCAST_ACTION_COPY28051;
            break;
        default:
 ...
 *          - UCAST_ACTION_COPY28051
 */
rtk_api_ret_t dal_rtl8367c_trap_unmatchMacPktAction_set(rtk_trap_ucast_action_t ucast_action)
{
    rtk_api_ret_t retVal;
    rtk_uint32 behavior;
    ...
    if ((retVal = rtl8367c_setAsicPortUnmatchedSaBehavior(behavior)) != RT_ERR_OK)
        return retVal;
 ...
 *          - UCAST_ACTION_TRAP2CPU
 */
rtk_api_ret_t dal_rtl8367c_trap_unmatchMacPktAction_get(rtk_trap_ucast_action_t *pUcast_action)
{
    rtk_api_ret_t retVal;
    rtk_uint32 behavior;
    ...
    if ((retVal = rtl8367c_getAsicPortUnmatchedSaBehavior(&behavior)) != RT_ERR_OK)
        return retVal;
 ...
 * Note:
 */
rtk_api_ret_t dal_rtl8367c_trap_unmatchMacMoving_set(rtk_port_t port, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
 ...
 * Note:
 */
rtk_api_ret_t dal_rtl8367c_trap_unmatchMacMoving_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
 ...
 */
rtk_api_ret_t dal_rtl8367c_trap_unknownMcastPktAction_set(rtk_port_t port, rtk_mcast_type_t type, rtk_trap_mcast_action_t mcast_action)
{
    rtk_api_ret_t retVal;
 ...
 *          - MCAST_ACTION_TRAP2CPU
 */
rtk_api_ret_t dal_rtl8367c_trap_unknownMcastPktAction_get(rtk_port_t port, rtk_mcast_type_t type, rtk_trap_mcast_action_t *pMcast_action)
{
    rtk_api_ret_t retVal;
    rtk_uint32 rawAction;
 ...
 */
rtk_api_ret_t dal_rtl8367c_trap_lldpEnable_set(rtk_enable_t enabled)
{
    rtk_api_ret_t retVal;
 ...
 *      - 01:80:c2:00:00:00 ethertype = 0x88CC
 */
rtk_api_ret_t dal_rtl8367c_trap_lldpEnable_get(rtk_enable_t *pEnabled)
{
    rtk_api_ret_t retVal;
    rtl8367c_rma_t rmacfg;
 ...
 */
rtk_api_ret_t dal_rtl8367c_trap_reasonTrapToCpuPriority_set(rtk_trap_reason_type_t type, rtk_pri_t priority)
{
    rtk_api_ret_t retVal;
    rtl8367c_rma_t rmacfg;
 ...
 *      - TRAP_REASON_UNKNOWNMC
 */
rtk_api_ret_t dal_rtl8367c_trap_reasonTrapToCpuPriority_get(rtk_trap_reason_type_t type, rtk_pri_t *pPriority)
{
    rtk_api_ret_t retVal;
    rtl8367c_rma_t rmacfg;
 ...
 */
rtk_api_ret_t dal_rtl8367c_trap_rmaAction_set(rtk_trap_type_t type, rtk_trap_rma_action_t rma_action)
{
    rtk_api_ret_t retVal;
    rtl8367c_rma_t rmacfg;
    rtk_uint32 tmp;
 ...
 *      - RMA_ACTION_FORWARD_EXCLUDE_CPU
 */
rtk_api_ret_t dal_rtl8367c_trap_rmaAction_get(rtk_trap_type_t type, rtk_trap_rma_action_t *pRma_action)
{
    rtk_api_ret_t retVal;
    rtl8367c_rma_t rmacfg;
    rtk_uint32 tmp;
 ...
 *      - TRAP_LLDP.
 */
rtk_api_ret_t dal_rtl8367c_trap_rmaKeepFormat_set(rtk_trap_type_t type, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
    rtl8367c_rma_t rmacfg;
    rtk_uint32 tmp;
 ...
 *      - TRAP_LLDP.
 */
rtk_api_ret_t dal_rtl8367c_trap_rmaKeepFormat_get(rtk_trap_type_t type, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
    rtl8367c_rma_t rmacfg;
    rtk_uint32 tmp;
