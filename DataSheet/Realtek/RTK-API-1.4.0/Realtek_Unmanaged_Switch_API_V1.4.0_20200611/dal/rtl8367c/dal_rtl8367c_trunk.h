...
#ifndef __DAL_RTL8367C_TRUNK_H__
#define __DAL_RTL8367C_TRUNK_H__

#include <trunk.h>

/* Function Name:
 *      dal_rtl8367c_trunk_port_set
 * Description:
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_trunk_port_set(rtk_trunk_group_t trk_gid, rtk_portmask_t *pTrunk_member_portmask);

/* Function Name:
 *      dal_rtl8367c_trunk_port_get
 * Description:
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_trunk_port_get(rtk_trunk_group_t trk_gid, rtk_portmask_t *pTrunk_member_portmask);
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_trunk_distributionAlgorithm_set(rtk_trunk_group_t trk_gid, rtk_uint32 algo_bitmask);

/* Function Name:
 *      dal_rtl8367c_trunk_distributionAlgorithm_get
 * Description:
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_trunk_distributionAlgorithm_get(rtk_trunk_group_t trk_gid, rtk_uint32 *pAlgo_bitmask);

/* Function Name:
 *      dal_rtl8367c_trunk_trafficSeparate_set
 * Description:
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_trunk_trafficSeparate_set(rtk_trunk_group_t trk_gid, rtk_trunk_separateType_t separateType);

/* Function Name:
 *      dal_rtl8367c_trunk_trafficSeparate_get
 * Description:
 ...
 *      SEPARATE_FLOOD: trunk MSB link up port is dedicated to TX flooding (L2 lookup miss) traffic
 */
extern rtk_api_ret_t dal_rtl8367c_trunk_trafficSeparate_get(rtk_trunk_group_t trk_gid, rtk_trunk_separateType_t *pSeparateType);
 ...
 *      - TRUNK_MODE_DUMB
 */
extern rtk_api_ret_t dal_rtl8367c_trunk_mode_set(rtk_trunk_mode_t mode);

/* Function Name:
 *      dal_rtl8367c_trunk_mode_get
 * Description:
 ...
 *      - TRUNK_MODE_DUMB
 */
extern rtk_api_ret_t dal_rtl8367c_trunk_mode_get(rtk_trunk_mode_t *pMode);

/* Function Name:
 *      dal_rtl8367c_trunk_trafficPause_set
 * Description:
 ...
 *      None.
 */
extern rtk_api_ret_t dal_rtl8367c_trunk_trafficPause_set(rtk_trunk_group_t trk_gid, rtk_enable_t enable);

/* Function Name:
 *      dal_rtl8367c_trunk_trafficPause_get
 * Description:
 ...
 *      None.
 */
extern rtk_api_ret_t dal_rtl8367c_trunk_trafficPause_get(rtk_trunk_group_t trk_gid, rtk_enable_t *pEnable);
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_trunk_hashMappingTable_set(rtk_trunk_group_t trk_gid, rtk_trunk_hashVal2Port_t *pHash2Port_array);

/* Function Name:
 *      dal_rtl8367c_trunk_hashMappingTable_get
 * Description:
 ...
 *      Trunk group 2 uses a independent table.
 */
extern rtk_api_ret_t dal_rtl8367c_trunk_hashMappingTable_get(rtk_trunk_group_t trk_gid, rtk_trunk_hashVal2Port_t *pHash2Port_array);

/* Function Name:
 *      dal_rtl8367c_trunk_portQueueEmpty_get
 * Description:
 ...
 *      None.
 */
extern rtk_api_ret_t dal_rtl8367c_trunk_portQueueEmpty_get(rtk_portmask_t *pEmpty_portmask);

#endif /* __DAL_RTL8367C_TRUNK_H__ */
