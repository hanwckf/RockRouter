...
#ifndef __DAL_RTL8367C_DOT1X_H__
#define __DAL_RTL8367C_DOT1X_H__
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_unauthPacketOper_set(rtk_port_t port, rtk_dot1x_unauth_action_t unauth_action);
 ...
 *      - DOT1X_ACTION_GUESTVLAN
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_unauthPacketOper_get(rtk_port_t port, rtk_dot1x_unauth_action_t *pUnauth_action);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_eapolFrame2CpuEnable_set(rtk_enable_t enable);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_eapolFrame2CpuEnable_get(rtk_enable_t *pEnable);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_portBasedEnable_set(rtk_port_t port, rtk_enable_t enable);
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_portBasedEnable_get(rtk_port_t port, rtk_enable_t *pEnable);
 ...
 *      - AUTH
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_portBasedAuthStatus_set(rtk_port_t port, rtk_dot1x_auth_status_t port_auth);
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_portBasedAuthStatus_get(rtk_port_t port, rtk_dot1x_auth_status_t *pPort_auth);
 ...
 *      - IN
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_portBasedDirection_set(rtk_port_t port, rtk_dot1x_direction_t port_direction);
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_portBasedDirection_get(rtk_port_t port, rtk_dot1x_direction_t *pPort_direction);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_macBasedEnable_set(rtk_port_t port, rtk_enable_t enable);
 ...
 *      - ENABLED
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_macBasedEnable_get(rtk_port_t port, rtk_enable_t *pEnable);
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_macBasedAuthMac_add(rtk_port_t port, rtk_mac_t *pAuth_mac, rtk_fid_t fid);
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_macBasedAuthMac_del(rtk_port_t port, rtk_mac_t *pAuth_mac, rtk_fid_t fid);
 ...
 *      - IN
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_macBasedDirection_set(rtk_dot1x_direction_t mac_direction);
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_macBasedDirection_get(rtk_dot1x_direction_t *pMac_direction);
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_guestVlan_set(rtk_vlan_t vid);
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_guestVlan_get(rtk_vlan_t *pVid);
 ...
 *      - DISABLED
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_guestVlan2Auth_set(rtk_enable_t enable);
 ...
 */
extern rtk_api_ret_t dal_rtl8367c_dot1x_guestVlan2Auth_get(rtk_enable_t *pEnable);
