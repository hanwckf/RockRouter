 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_rate_stormControlMeterIdx_set(rtk_port_t port, rtk_rate_storm_group_t stormType, rtk_uint32 index)
{
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_rate_stormControlMeterIdx_get(rtk_port_t port, rtk_rate_storm_group_t stormType, rtk_uint32 *pIndex)
{
    rtk_api_ret_t retVal;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_rate_stormControlPortEnable_set(rtk_port_t port, rtk_rate_storm_group_t stormType, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_rate_stormControlPortEnable_get(rtk_port_t port, rtk_rate_storm_group_t stormType, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
 ...
 *      - BYPASS_LLDP.
 */
rtk_api_ret_t dal_rtl8367c_storm_bypass_set(rtk_storm_bypass_t type, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
 ...
 *      - BYPASS_LLDP.
 */
rtk_api_ret_t dal_rtl8367c_storm_bypass_get(rtk_storm_bypass_t type, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
    rtl8367c_rma_t rmacfg;
    rtk_uint32 tmp;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_rate_stormControlExtPortmask_set(rtk_portmask_t *pPortmask)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pmask;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_rate_stormControlExtPortmask_get(rtk_portmask_t *pPortmask)
{
    rtk_api_ret_t retVal;
    rtk_uint32 pmask;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_rate_stormControlExtEnable_set(rtk_rate_storm_group_t stormType, rtk_enable_t enable)
{
    rtk_api_ret_t retVal;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_rate_stormControlExtEnable_get(rtk_rate_storm_group_t stormType, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_rate_stormControlExtMeterIdx_set(rtk_rate_storm_group_t stormType, rtk_uint32 index)
{
    rtk_api_ret_t retVal;
 ...
 *
 */
rtk_api_ret_t dal_rtl8367c_rate_stormControlExtMeterIdx_get(rtk_rate_storm_group_t stormType, rtk_uint32 *pIndex)
{
    rtk_api_ret_t retVal;
