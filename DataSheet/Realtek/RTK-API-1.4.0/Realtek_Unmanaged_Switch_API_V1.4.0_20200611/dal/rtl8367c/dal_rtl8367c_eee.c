 ...
 */
rtk_api_ret_t dal_rtl8367c_eee_init(void)
{
...
/* Function Name:
 *      dal_rtl8367c_eee_portEnable_set
 * Description:
 ...
 *      - ENABLE
 */
rtk_api_ret_t dal_rtl8367c_eee_portEnable_set(rtk_port_t port, rtk_enable_t enable)
{
    rtk_api_ret_t   retVal;
    rtk_uint32      regData;
    rtk_uint32    phy_port;
...
/* Function Name:
 *      dal_rtl8367c_eee_portEnable_get
 * Description:
 ...
 *      - ENABLE
 */
rtk_api_ret_t dal_rtl8367c_eee_portEnable_get(rtk_port_t port, rtk_enable_t *pEnable)
{
    rtk_api_ret_t retVal;
