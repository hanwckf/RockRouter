 ...
 */
rtk_api_ret_t dal_rtl8367c_filter_igrAcl_cfg_delAll(void)
{
    rtk_uint32            i;
    rtk_api_ret_t     ret;
 ...
 */
rtk_api_ret_t dal_rtl8367c_filter_igrAcl_init(void)
{
    ...
    if ((ret = dal_rtl8367c_filter_igrAcl_cfg_delAll()) != RT_ERR_OK)
        return ret;
 ...
 */
rtk_api_ret_t dal_rtl8367c_filter_igrAcl_field_add(rtk_filter_cfg_t* pFilter_cfg, rtk_filter_field_t* pFilter_field)
{
    rtk_uint32 i;
 ...
 */
rtk_api_ret_t dal_rtl8367c_filter_igrAcl_cfg_add(rtk_filter_id_t filter_id, rtk_filter_cfg_t* pFilter_cfg, rtk_filter_action_t* pFilter_action, rtk_filter_number_t *ruleNum)
{
    ...
    for(actType = 0; actType < FILTER_ENACT_END; actType ++)
    {
        if(pFilter_action->actEnable[actType])
        {
            ...
            case FILTER_ENACT_CVLAN_INGRESS:
                ...
                if((retVal = dal_rtl8367c_vlan_checkAndCreateMbr(pFilter_action->filterCvlanVid, &vidx)) != RT_ERR_OK)
                {
                    return retVal;
                }
            ...
            case FILTER_ENACT_CVLAN_EGRESS:
             ...
             case FILTER_ENACT_POLICING_1:
                if(pFilter_action->filterPolicingIdx[1] >= ((RTK_MAX_METER_ID + 1) + RTL8367C_MAX_LOG_CNT_NUM))
                    return RT_ERR_INPUT;
            ...
            case FILTER_ENACT_SVLAN_EGRESS:
                ...
                if((retVal = dal_rtl8367c_svlan_checkAndCreateMbr(pFilter_action->filterSvlanVid, &svidx)) != RT_ERR_OK)
                    return retVal;
            ...
            case FILTER_ENACT_POLICING_2:
                if(pFilter_action->filterPolicingIdx[2] >= ((RTK_MAX_METER_ID + 1) + RTL8367C_MAX_LOG_CNT_NUM))
                    return RT_ERR_INPUT;
            ...
            case FILTER_ENACT_POLICING_0:
                if(pFilter_action->filterPolicingIdx[0] >= ((RTK_MAX_METER_ID + 1) + RTL8367C_MAX_LOG_CNT_NUM))
                    return RT_ERR_INPUT;
            ...
            case FILTER_ENACT_POLICING_3:
                if(pFilter_action->filterPriority >= ((RTK_MAX_METER_ID + 1) + RTL8367C_MAX_LOG_CNT_NUM))
                    return RT_ERR_INPUT;
 ...
 */
rtk_api_ret_t dal_rtl8367c_filter_igrAcl_cfg_del(rtk_filter_id_t filter_id)
{
 ...
 */
rtk_api_ret_t dal_rtl8367c_filter_igrAcl_cfg_get(rtk_filter_id_t filter_id, rtk_filter_cfg_raw_t *pFilter_cfg, rtk_filter_action_t *pAction)
{
    rtk_api_ret_t               retVal;
    rtk_uint32                  i, tmp;
 ...
 */
rtk_api_ret_t dal_rtl8367c_filter_igrAcl_unmatchAction_set(rtk_port_t port, rtk_filter_unmatch_action_t action)
{
    rtk_api_ret_t ret;
 ...
 */
rtk_api_ret_t dal_rtl8367c_filter_igrAcl_unmatchAction_get(rtk_port_t port, rtk_filter_unmatch_action_t* pAction)
{
    rtk_api_ret_t ret;
 ...
 *      This function gets action of packets when no ACL configruation matches.
 */
rtk_api_ret_t dal_rtl8367c_filter_igrAcl_state_set(rtk_port_t port, rtk_filter_state_t state)
{
    rtk_api_ret_t ret;
 ...
 *      This function gets action of packets when no ACL configruation matches.
 */
rtk_api_ret_t dal_rtl8367c_filter_igrAcl_state_get(rtk_port_t port, rtk_filter_state_t* pState)
{
    rtk_api_ret_t ret;
 ...
 */
rtk_api_ret_t dal_rtl8367c_filter_igrAcl_template_set(rtk_filter_template_t *aclTemplate)
{
    rtk_api_ret_t retVal;
    rtk_uint32 idxField;
 ...
 */
rtk_api_ret_t dal_rtl8367c_filter_igrAcl_template_get(rtk_filter_template_t *aclTemplate)
{
    rtk_api_ret_t ret;
    rtk_uint32 idxField;
    rtl8367c_acltemplate_t aclType;
 ...
 */
rtk_api_ret_t dal_rtl8367c_filter_igrAcl_field_sel_set(rtk_uint32 index, rtk_field_sel_t format, rtk_uint32 offset)
{
    rtk_api_ret_t ret;
 ...
 *      None.
 */
rtk_api_ret_t dal_rtl8367c_filter_igrAcl_field_sel_get(rtk_uint32 index, rtk_field_sel_t *pFormat, rtk_uint32 *pOffset)
{
    rtk_api_ret_t ret;
 ...
 */
rtk_api_ret_t dal_rtl8367c_filter_iprange_set(rtk_uint32 index, rtk_filter_iprange_t type, ipaddr_t upperIp, ipaddr_t lowerIp)
{
    rtk_api_ret_t ret;
 ...
 *      None.
 */
rtk_api_ret_t dal_rtl8367c_filter_iprange_get(rtk_uint32 index, rtk_filter_iprange_t *pType, ipaddr_t *pUpperIp, ipaddr_t *pLowerIp)
{
    rtk_api_ret_t ret;
 ...
 */
rtk_api_ret_t dal_rtl8367c_filter_vidrange_set(rtk_uint32 index, rtk_filter_vidrange_t type, rtk_uint32 upperVid, rtk_uint32 lowerVid)
{
    rtk_api_ret_t ret;
 ...
 *      None.
 */
rtk_api_ret_t dal_rtl8367c_filter_vidrange_get(rtk_uint32 index, rtk_filter_vidrange_t *pType, rtk_uint32 *pUpperVid, rtk_uint32 *pLowerVid)
{
    rtk_api_ret_t ret;
 ...
 */
rtk_api_ret_t dal_rtl8367c_filter_portrange_set(rtk_uint32 index, rtk_filter_portrange_t type, rtk_uint32 upperPort, rtk_uint32 lowerPort)
{
    rtk_api_ret_t ret;
 ...
 *      None.
 */
rtk_api_ret_t dal_rtl8367c_filter_portrange_get(rtk_uint32 index, rtk_filter_portrange_t *pType, rtk_uint32 *pUpperPort, rtk_uint32 *pLowerPort)
{
    rtk_api_ret_t ret;
 ...
 *      none
 */
rtk_api_ret_t dal_rtl8367c_filter_igrAclPolarity_set(rtk_uint32 polarity)
{
    /* Check initialization state */
    RTK_CHK_INIT_STATE();
 ...
 *      none
 */
rtk_api_ret_t dal_rtl8367c_filter_igrAclPolarity_get(rtk_uint32* pPolarity)
{
    /* Check initialization state */
    RTK_CHK_INIT_STATE();
